...
const renderCustomizedLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, country, count, code }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg"  id="flag-icon-css-lk" viewBox="0 0 640 480">
      ...
      <use width="100%" height="100%" transform="matrix(-1 0 0 1 845.3 0)" />
      <use width="100%" height="100%" transform="matrix(1 0 0 -1 0 480)" />
      <use width="100%" height="100%" transform="rotate(180 422.7 240)" />
      <g transform="translate(0 -76)">
        <use width="100%" height="100%" stroke="#000" stroke-width="5.6" />
        <g id="b" fill="#ffb700">
